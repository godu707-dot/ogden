...
import { createVignetteShader } from "./shaders/vignetteShader"
import { ThreeContext } from './ThreeContext'

export default function ThreeWrapper({ hovering }: { hovering: boolean }) {
  ...
  // Don't render until THREE is available
  if (!THREE) return <div id="webgl" />

  const vignetteShader = createVignetteShader(THREE)
